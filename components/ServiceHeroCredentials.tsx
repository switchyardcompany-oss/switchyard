export default function ServiceHeroCredentials() {
  return (
    <aside className="service-hero-credentials" aria-label="Professional credentials and affiliations">
      <a
        href="https://www.bbb.org/us/fl/tampa/profile/electrical-engineer/keentel-engineering-0653-90446480#licensing"
        className="service-hero-credential"
        target="_blank"
