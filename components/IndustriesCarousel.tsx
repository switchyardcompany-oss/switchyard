...
export default function IndustriesCarousel() {
  ...
  const industries = [
    ...
    { name: "Retail & Mixed-Use", img: "/images/industries/retail-mixed-use.webp" },
    { name: "Restaurants & Hospitality", img: "/images/industries/restaurants-hospitality-custom.webp" },
