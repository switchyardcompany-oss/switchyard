...
export default function EmergencyRestorationPage() {
  ...
  const handleFormSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const result = await submitLead({ formSource: "emergency-restoration", fullName: data.get("fullName"), company: data.get("company"), email: data.get("email"), phone: data.get("phone"), location: data.get("location"), projectType: data.get("projectType"), message: data.get("details") });
    ...
    <main className="ers-about-page">
      ...
      <section className="ers-hero-section">
        <video
          ...
          aria-hidden="true"
          >
            <source src="/Video/emergency-restoration-mobile.mp4" media="(max-width: 768px)" type="video/mp4" />
          ...
          <div className="ers-services-layout">
            <div className="ers-services-left ers-reveal">
              ...
              <div className="ers-services-image-wrapper">
                <Image
                  src="/images/services/complete-emergency-restoration-services.webp"
          ...
          <div className="ers-contact-grid">
            <form className="ers-contact-form ers-reveal ers-reveal-delay-2" ref={formRef} onSubmit={handleFormSubmit}>
              <div className="ers-form-row">
                <input type="text" name="fullName" className="ers-form-input" placeholder="Full Name *" required />
                <input type="text" className="ers-form-input" placeholder="Company (Optional)" />
              </div>
              <div className="ers-form-row">
                <input type="email" name="email" className="ers-form-input" placeholder="Email Address *" required />
                <input type="tel" name="phone" pattern="[0-9()+.\-\s]{10,}" className="ers-form-input" placeholder="Phone Number" required />
              </div>
              <div className="ers-form-row">
                <input type="text" name="location" className="ers-form-input" placeholder="Property Address" />
                <select name="projectType" className="ers-form-select" required>
              ...
              <textarea name="details" className="ers-form-textarea" placeholder="Tell Us About the Damage *" required></textarea>
