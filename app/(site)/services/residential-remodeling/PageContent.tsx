...
export default function ResidentialRemodelingPage() {
  ...
  const handleFormSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const result = await submitLead({ formSource: "residential-remodeling", fullName: data.get("fullName"), email: data.get("email"), phone: data.get("phone"), location: data.get("location"), projectType: data.get("projectType"), message: data.get("details") });
  ...
  const projectTypes = [
    {
      ...
      image: "/images/services/whole-home-renovations.webp",
    },
    {
      icon: faUtensils,
    ...
    },
    {
      ...
      image: "/images/services/home-additions.webp",
    },
    {
      icon: faBuilding,
    ...
    },
    {
      ...
      image: "/images/services/interior-renovations.webp",
    },
  ];
          ...
          <div className="rrs-services-layout">
            <div className="rrs-services-left rrs-reveal">
              ...
              <div className="rrs-services-image-wrapper">
                <Image
                  src="/images/services/interior-renovations.webp"
          ...
          <div className="rrs-contact-grid">
            <form className="rrs-contact-form rrs-reveal rrs-reveal-delay-2" ref={formRef} onSubmit={handleFormSubmit}>
              <div className="rrs-form-row">
                <input type="text" name="fullName" className="rrs-form-input" placeholder="Full Name *" required />
                <input type="email" name="email" className="rrs-form-input" placeholder="Email Address *" required />
              </div>
              <div className="rrs-form-row">
                <input type="tel" name="phone" pattern="[0-9()+.\-\s]{10,}" className="rrs-form-input" placeholder="Phone Number" required />
                <input type="text" name="location" className="rrs-form-input" placeholder="Property Address" />
              </div>
              <div className="rrs-form-row">
                <select name="projectType" className="rrs-form-select" required>
              ...
              <textarea name="details" className="rrs-form-textarea" placeholder="Tell Us About Your Project *" required></textarea>
