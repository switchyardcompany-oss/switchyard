...
export default function GeneralConstructionPage() {
  ...
  const handleFormSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const result = await submitLead({ formSource: "general-construction", fullName: data.get("fullName"), company: data.get("company"), email: data.get("email"), phone: data.get("phone"), location: data.get("location"), projectType: data.get("projectType"), message: data.get("details") });
    ...
    <main className="gcs-about-page">
      ...
      <section className="gcs-hero-section">
        <video
          ...
          aria-hidden="true"
          >
            <source src="/Video/general-construction-mobile.mp4" media="(max-width: 768px)" type="video/mp4" />
            <source
          ...
          <div className="gcs-contact-grid">
            <form className="gcs-contact-form gcs-reveal gcs-reveal-delay-2" ref={formRef} onSubmit={handleFormSubmit}>
              <div className="gcs-form-row">
                <input type="text" name="fullName" className="gcs-form-input" placeholder="Full Name *" required />
                <input type="text" className="gcs-form-input" placeholder="Company Name" />
              </div>
              <div className="gcs-form-row">
                <input type="email" name="email" className="gcs-form-input" placeholder="Email Address *" required />
                <input type="tel" name="phone" pattern="[0-9()+.\-\s]{10,}" className="gcs-form-input" placeholder="Phone Number" required />
              </div>
              <div className="gcs-form-row">
                <input type="text" name="location" className="gcs-form-input" placeholder="Project Location" />
                <select name="projectType" className="gcs-form-select" required>
              ...
              <textarea name="details" className="gcs-form-textarea" placeholder="Tell Us About Your Project *" required></textarea>
