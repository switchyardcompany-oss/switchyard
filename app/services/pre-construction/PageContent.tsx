      ...
      <section className="pc-hero-section">
        <div className="pc-hero-image" aria-hidden="true">
          ...
          preload="metadata"
            >
              <source
                src="/Video/successful-project-begins-before-construction-starts-mobile.mp4"
                media="(max-width: 768px)"
                type="video/mp4"
              />
              <source
              src="/Video/successful-project-begins-before-construction-starts.mp4"
              type="video/mp4"
            />
          </video>
        </div>
          ...
          <div className="pc-about-grid">
            ...
            <div className="pc-about-visual pc-reveal pc-reveal-delay-2">
              <Image
                ...
                src="/images/services/about-our-pre-construction-services.webp"
          ...
          <div className="pc-services-layout">
            <div className="pc-services-left pc-reveal">
              ...
              <div className="pc-services-image-wrapper">
                <Image
                  src="/images/services/about-our-pre-construction-services.webp"
                  alt="Construction manager reviewing pre-construction site plans"
