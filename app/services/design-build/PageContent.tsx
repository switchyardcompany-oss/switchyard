...
export default function DesignBuildPage() {
  ...
  const handleFormSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const result = await submitLead({ formSource: "design-build", fullName: data.get("fullName"), company: data.get("company"), email: data.get("email"), phone: data.get("phone"), location: data.get("location"), projectType: data.get("projectType"), message: data.get("details") });
  ...
  const projectTypes = [
    ...
    },
    {
      ...
      image: "/images/services/large-residential-projects.webp",
    },
  ];
    ...
    <main className="dbs-about-page">
      ...
      <section className="dbs-hero-section">
        <video
          ...
          aria-hidden="true"
          >
            <source src="/images/services/one-team-one-contract-one-seamless-process-mobile.mp4" media="(max-width: 768px)" type="video/mp4" />
            <source
            src="/images/services/one-team-one-contract-one-seamless-process.mp4"
            type="video/mp4"
          />
        </video>
        ...
        <div className="dbs-container">
          <div className="dbs-about-grid">
            ...
            <div className="dbs-about-visual dbs-reveal dbs-reveal-delay-2">
              <Image
                src="/images/services/one-team-one-vision-one-successful-project.webp"
          ...
          <div className="dbs-services-layout">
            <div className="dbs-services-left dbs-reveal">
              ...
              <div className="dbs-services-image-wrapper">
                <Image
                  src="/images/services/comprehensive-design-build-services.webp"
          ...
          <div className="dbs-contact-grid">
            <form className="dbs-contact-form dbs-reveal dbs-reveal-delay-2" ref={formRef} onSubmit={handleFormSubmit}>
              <div className="dbs-form-row">
                <input type="text" name="fullName" className="dbs-form-input" placeholder="Full Name *" required />
                <input type="text" className="dbs-form-input" placeholder="Company" />
              </div>
              <div className="dbs-form-row">
                <input type="email" name="email" className="dbs-form-input" placeholder="Email Address *" required />
                <input type="tel" name="phone" pattern="[0-9()+.\-\s]{10,}" className="dbs-form-input" placeholder="Phone Number" required />
              </div>
              <div className="dbs-form-row">
                <input type="text" name="location" className="dbs-form-input" placeholder="Project Location" />
                <select name="projectType" className="dbs-form-select" required>
              ...
              <textarea name="details" className="dbs-form-textarea" placeholder="Tell Us About Your Project *" required></textarea>
